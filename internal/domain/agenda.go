...
func (a *Agenda) IsLocked(repo port.Repository, tx interface{}, timeout int) bool {
...
func (c *Agenda) validateDuplicity(repo port.Repository, tx interface{}, noduplicity bool) error {
	if noduplicity {
		return nil
	}
