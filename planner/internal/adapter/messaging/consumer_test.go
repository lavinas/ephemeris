...
func (m *mockRepo) Find(page, pagesize int, conditions map[string]interface{}, orderBy ...string) ([]interface{}, error) {
	return nil, nil
}

func (m *mockRepo) FindCount(conditions map[string]interface{}) (int64, error) {
	return 0, nil
}

func (m *mockRepo) FindGroup(conditions map[string]interface{}, groupField string) ([]map[string]interface{}, error) {
	return nil, nil
}
